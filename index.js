...
/*
 * File: index.js
 * Created: Wednesday, 17th September 2025 2:43:55 pm
 * Author: Md.Rahad (mdrahad1296@gmail.com)
 * -----
 * Last Modified: Thursday, 18th September 2025 2:04:37 pm
...
newLi.textContent = `You have completed the task ${name} at ${today}`
    newLi.classList.add("mb-4", "bg-gray-100", "rounded-[8px]", "w-[]", "h-[]", "p-[10px]")
    newLi.classList.add("mb-4", "bg-gray-100", "rounded-[8px]", "w-[]", "min-h-[68px]", "p-[10px]")
